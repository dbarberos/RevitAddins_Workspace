...
SIEMPRE que el desarrollador/usuario indique que los últimos cambios o correcciones ya funcionan correctamente, o al finalizar una iteración, el agente DEBE automáticamente guardar/copiar sus artefactos generados (`implementation_plan.md`, `task.md`, `walkthrough.md`) dentro de la carpeta `docs/` del proyecto actual.
- Filenames MUST follow the pattern: `[artifact_name]_[keywords]_[YYYY-MM-DD_HHmm].md` where keywords are 1 or 2 descriptive words relating to the changes.
- Example: `implementation_plan_UI_TreeFix_2026-04-21_1040.md`.
