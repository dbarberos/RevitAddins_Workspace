...
- [ ] **T1: Scaffold TablePlus Project & Manifests** (Maps to: `RF-6.4`)
...
- [ ] **T2: Implement Pure Domain Models** (Maps to: `RF-1`, `RF-2`, `RF-3`)
...
- [ ] **T3: Implement ExcelReaderService with ClosedXML / OpenXML** (Maps to: `RF-1`, `RF-2`, `RF-4.5`)
...
- [ ] **T4: Implement TableGeometryService & WarningSwallower** (Maps to: `RF-4`, `AC-3`, `AC-4`, `AC-5`)
...
- [ ] **T5: Implement SchemaService for Tracking & Future Sync** (Maps to: `RF-5`, `AC-6`)
