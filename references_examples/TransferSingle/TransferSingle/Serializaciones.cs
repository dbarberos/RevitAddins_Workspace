...
namespace TransferSingleApp
{
	...
	public static class Serializaciones
	{
		...
		{
			return (!!0)((object)Serializaciones.XmlDeserializeFromString(objectData, typeof(!!0)));
		}
		...
		public static object XmlDeserializeFromString(string objectData, Type type)
		{
			...
			{
				MessageBox.Show(ex.Message + " Probably you have updated TransferSingle recently");
				result = null;
			}
			return result;
		}
