...
namespace TransferSingleApp
{
	...
	public class Configuraciones
	{
		...
		public Size VentanaTamano = new Size(490, 750);

		// Token: 0x04000086 RID: 134
		public Point VentanaPosicion = new Point((Screen.PrimaryScreen.WorkingArea.Width - 490) / 2, (Screen.PrimaryScreen.WorkingArea.Height - 750) / 2);
