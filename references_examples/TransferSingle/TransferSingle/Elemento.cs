...
namespace TransferSingleApp
{
	...
	public class Elemento
	{
		...
		public Elemento(Element el)
		{
			...
			if (el.get_Parameter(-1002050).AsValueString() != null)
			{
				this.Tipo = el.get_Parameter(-1002050).AsValueString();
			}
			else
			{
				this.Tipo = "Undefined";
			...
			if (el.get_Parameter(-1002002) != null)
			{
				Parameter parameter = el.get_Parameter(-1002002);
				if (parameter.StorageType == 4)
				{
		...
		public Elemento(Element el, string CategoriaForzada, int caso, Document docin)
		{
			if (caso == 0)
			{
				...
				if (el.get_Parameter(-1002051).AsValueString() != null)
				{
					this.Familia = el.get_Parameter(-1002051).AsValueString();
				}
				else
				{
					this.Familia = "Undefined";
				...
				if (spatialElement != null)
				{
					...
					if (spatialElement.get_Parameter(-1006900).AsString() != null)
					{
						this.Nombre = spatialElement.get_Parameter(-1006900).AsString();
						return;
					}
				}
			}
			else
			{
				if (caso == 1)
				{
					if (el.get_Parameter(-1011952).AsString() != null)
					{
						this.Nombre = el.get_Parameter(-1011952).AsString();
					}
					else
					{
						this.Nombre = "Undefined";
